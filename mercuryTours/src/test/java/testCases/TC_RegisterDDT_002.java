...
public class TC_RegisterDDT_002 extends BaseClass
{
	...
	String address2, String city, String state, String zipcode, String country, String email,String password, String confirmPassword)
	{
	...
	{
		String path = System.getProperty("user.dir")+"/MercuryTestData.xlsx";
